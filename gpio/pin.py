...
class Pin:
    ...
    def __default_callback(self):
        ...
        :return: None
        """
        self._logger.info("PIN-{0} - Input state change detected".format(self._pin))

    def __input_monitor(self, low_callback=__default_callback, high_callback=__default_callback):
        """
